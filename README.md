...
# **Data availability**
Data used for this study were deposited into the European Nucleotide Archive (ENA). The raw 2019 metagenomic sequencing reads for the studied samples were deposited under ENA project accession PRJEB36505, and raw 2022 metagenomic sequencing reads for the studied samples were deposited under project accession PRJNA1236243. Processed data are available through iVirus, including viral populations (≥ 5 kb and ≥ 10 kb), AMG genes, AMG cluster genes, and identified CRIPSR-Cas spacers (XXXXX).
